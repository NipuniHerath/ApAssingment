...
CREATE TABLE `account` (
  ...
  `joprole` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `account` VALUES ('admin','admin',1,NULL,NULL,NULL,NULL,NULL,'admin'),('sakilasandanuwan1999@gmail.com','qqq',2,'www','eee','rrr','2023-03-14',NULL,'client');
